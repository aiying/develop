...
#define RDB_VERSION       0x0121       /**< upper byte = major, lower byte = minor  @version 0x011D */
/** @} */
...
typedef struct
{
    ...
    uint32_t            channelMask;                /**< channel mask                                                  @unit _                                      @version 0x0121 */
    uint32_t            spare[3];                   /**< reserved for future use                                       @unit _                                      @version 0x011F */
} RDB_SYMBOL_STATE_t;
...
typedef struct
{
    ...
    uint8_t             spare0;                    /**< reserved for future use                                        @unit _                                      @version 0x0121 */
